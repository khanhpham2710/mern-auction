      ...
      <div className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
        ...
        >
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            <div className="flex flex-col sm:flex-1">
              <Label htmlFor="startingBid" className="text-[16px] text-stone-600">
                Starting Bid
              </Label>
              <Input
                id="startingBid"
                ...
                className="text-[16px] py-2 bg-transparent border-b-[1px] border-b-stone-500 focus:outline-none"
              />
              {errors.startingBid && <span className="text-red-500 text-sm">{errors.startingBid.message}</span>}
            </div>
          </div>

          <div className="flex flex-col gap-4 sm:flex-row">
            <div className="flex flex-col sm:flex-1">
              <Label htmlFor="description" className="text-[16px] text-stone-600">
                Description
              </Label>
              <Textarea
                id="description"
          ...
          <div className="flex flex-col gap-4">
            <Label htmlFor="image" className="font-semibold text-xl md:text-2xl">
              Auction Item Image
            </Label>
            <div className="flex items-center justify-center w-full">
              ...
              >
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  {imagePreview ? (
                    <img src={imagePreview} alt="Auction" className="w-44 h-auto" />
                  ) : (
                    <>
                      <svg

    ...
    <>
      <div>
        ...
        <p className="text-xl text-stone-600">
          Welcome to Auction, the ultimate destination for online auctions and
      ...
      <div>
        ...
        <p className="text-xl text-stone-600">
          ...
          that empowers individuals and businesses to discover unique products,
      ...
      <div>
        ...
        <p className="text-xl text-stone-600">
          ...
          and valuable items. With years of experience in the auction industry,
          our team is committed to creating a platform that offers an
          unparalleled auction experience for users worldwide.
        </p>
      </div>
      <div>
        <h3
      ...
      <div>
        <p className="text-[#d6482b] text-xl font-bold mb-3">
          This is a Auction Project using MERN Stack(MongoDB, ExpressJS, ReactJS
          and NodeJS) developed by Duy Khánh.
        </p>
      </div>
    </>
  );

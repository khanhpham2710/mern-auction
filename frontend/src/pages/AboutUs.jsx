      ...
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div>
          ...
          <p className="text-xl text-stone-600">
            Welcome to Auction, the ultimate destination for online auctions
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Our mission is to revolutionize the way people buy and sell items
            online. We strive to create an engaging and trustworthy marketplace
            that empowers individuals and businesses to discover unique
            products, make informed decisions, and enjoy the thrill of
            competitive bidding.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Auction was born out of a passion for connecting people with unique
            and valuable items. With years of experience in the auction
            industry, our team is committed to creating a platform that offers
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Whether you&apos;re looking to buy, sell, or simply explore,
            PrimeBid invites you to join our growing community of auction
            enthusiasts. Discover new opportunities, uncover hidden gems, and
            experience the thrill of winning your next great find.
          </p>
        </div>
        <div>
          <p className="text-[#d6482b] text-xl font-bold mb-3">
            This is a Auction Project using MERN Stack(MongoDB, ExpressJS,
            ReactJS and NodeJS) developed by Duy Khánh.
          </p>
        </div>
      </section>
    </>
